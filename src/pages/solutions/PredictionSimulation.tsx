...
export default function PredictionSimulation() {
  return (
    <>
      <SEO
        title="Predictive Intelligence | Cognitive Capacity Prediction | NeuroState"
      ...
      <BreadcrumbStructuredData
        items={[
          ...
          { name: "Predictive Intelligence", url: "https://neurostate.co.uk/solutions/prediction" }
        ]}
      />
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <h3 className="text-lg font-medium text-foreground group-hover:text-primary transition-colors">AI Coaching</h3>
