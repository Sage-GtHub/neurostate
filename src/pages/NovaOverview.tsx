...
export default function NovaOverview() {
  ...
  return (
    <NovaSwipeWrapper>
      <SEO title="Nova AI | Cognitive Performance Forecasting Engine" description="Nova is a multi-model AI engine that forecasts cognitive performance using wearable data." />
