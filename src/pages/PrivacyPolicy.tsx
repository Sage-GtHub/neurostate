        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-slate max-w-none space-y-8">
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed mt-4">
                To exercise any of these rights, please contact us at privacy@neurostate.fit. We will respond to your request within 30 days.
              </p>
            </section>
            ...
            <section>
              ...
              <div className="p-6 bg-muted/30 rounded-lg space-y-3">
                <p className="text-muted-foreground">
                  ...
                  NeuroState®<br />
                  Email: privacy@neurostate.fit<br />
