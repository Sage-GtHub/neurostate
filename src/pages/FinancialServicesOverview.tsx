...
import { ArrowRight, ArrowUpRight, Check, TrendingUp, Brain, Shield, Clock, Target, Zap } from "lucide-react";
import { Link } from "react-router-dom";
import { motion } from "framer-motion";

const FinancialServicesOverview = () => {
  const stats = [
    { value: "23%", label: "Performance uplift", desc: "in high-stakes decision making" },
    { value: "47%", label: "Reduced errors", desc: "during peak trading hours" },
    { value: "3.2x", label: "ROI", desc: "within first year" },
    { value: "89%", label: "Team adoption", desc: "across trading floors" }
  ];

  const solutions = [
    { 
      title: "Cognitive Load Monitoring", 
      desc: "Real-time tracking of mental fatigue and decision-making capacity during high-pressure trading sessions and deal execution.",
      detail: "Seamless integration with existing trading infrastructure.",
      num: "01",
      icon: Brain
    },
    { 
      title: "Peak Performance Windows", 
      desc: "AI-predicted optimal time windows for critical decisions, client meetings, and complex analysis work.",
      detail: "Personalised to individual circadian rhythms and work patterns.",
      num: "02",
      icon: Target
    },
    { 
      title: "Risk & Stress Management", 
      desc: "Proactive intervention protocols to maintain composure during market volatility and high-stakes situations.",
  ...
  const benefits = [
    { title: "Sharper decision making", desc: "Reduce cognitive bias during critical moments" },
    { title: "Sustained peak performance", desc: "Maintain focus through long trading sessions" },
    { title: "Reduced burnout", desc: "Proactive fatigue management for teams" },
    { title: "Competitive advantage", desc: "Outperform when stakes are highest" }
  ];

  const useCases = [
    { title: "Investment Banks", desc: "Trading floors and deal teams" },
    { title: "Hedge Funds", desc: "Portfolio managers and analysts" },
    { title: "Private Equity", desc: "Due diligence and execution teams" },
    { title: "Asset Management", desc: "Research and client-facing teams" }
  ];

  return (
    <>
      <SEO 
        title="Financial Services Solutions | Neurostate"
        description="AI-powered cognitive performance for trading floors, investment banks, and financial institutions. Optimise decision-making during high-stakes moments."
      />
              ...
              <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                ...
                >
                  <div className="inline-flex items-center gap-2">
                    ...
                    />
                    <span className="text-[10px] tracking-[0.2em] uppercase text-muted-foreground">Financial Services</span>
                  </div>
                  ...
                  <p className="text-sm text-muted-foreground max-w-md leading-relaxed">
                    Elite cognitive performance for high-stakes finance. Predict mental fatigue, optimise decision windows, and maintain peak focus when millions are on the line.
                  </p>
                  ...
                  <div className="flow-card p-8 space-y-6">
                    <div className="flex items-center justify-between pb-4 border-b border-border/50">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p className="text-foreground font-medium text-sm">Trading Floor</p>
                          <p className="text-muted-foreground text-[10px]">Real-time cognitive monitoring</p>
                        </div>
                      </div>
                      <div className="flex items-center gap-1.5">
                        <div className="w-1.5 h-1.5 bg-green-500 rounded-full animate-pulse" />
                        <span className="text-[10px] text-muted-foreground">Markets Open</span>
                      </div>
                    </div>
                    
                    <div className="grid grid-cols-2 gap-4">
                      {[
                        { label: "Focus Score", value: "94%", trend: "Peak" },
                        { label: "Cognitive Load", value: "62%", trend: "Optimal" },
                        { label: "Decision Window", value: "2.5h", trend: "Remaining" },
                        { label: "Risk Tolerance", value: "High", trend: "Steady" }
                      ].map((metric, i) => (
                        <motion.div 
                          key={i}
                    ...
                    <div className="pt-4 border-t border-border/50">
                      <div className="flex items-center justify-between">
                        <div>
                          <p className="text-[10px] text-muted-foreground uppercase tracking-wider">Next Break Recommended</p>
                          <p className="text-sm font-medium text-foreground mt-1">In 47 minutes</p>
                        </div>
                        <div className="flex items-center gap-2">
                          <Zap className="w-4 h-4 text-primary" />
                          <span className="text-xs text-primary font-medium">Peak window active</span>
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <div className="max-w-6xl mx-auto">
              <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-start">
                <ScrollReveal className="lg:sticky lg:top-28 space-y-5">
                  <span className="text-[10px] tracking-[0.2em] uppercase text-primary font-medium">Trading Solutions</span>
                  ...
                  <p className="text-sm text-muted-foreground leading-relaxed max-w-sm">
                    Purpose-built for the intensity of financial markets. From trading floors to boardrooms, we help your team perform when it matters most.
                  </p>
                </ScrollReveal>
          ...
          <section className="py-24 md:py-32 px-6 md:px-8 bg-muted/30">
            <div className="max-w-6xl mx-auto">
              <ScrollReveal className="text-center mb-16 space-y-4 max-w-2xl mx-auto">
                <span className="text-[10px] tracking-[0.2em] uppercase text-primary font-medium">Institutional Benefits</span>
                <h2 className="text-large-display text-foreground">
                  Outperform the competition.
                  <br />
                  <span className="text-muted-foreground">Protect your edge.</span>
                </h2>
              </ScrollReveal>
            ...
            <div className="max-w-4xl mx-auto text-center">
              <ScrollReveal>
                ...
                <h2 className="text-large-display text-foreground mt-4 mb-6">
                  Ready to gain the cognitive edge?
                </h2>
                <p className="text-sm text-muted-foreground max-w-lg mx-auto mb-8">
                  Schedule a confidential demonstration to see how Neurostate can help your trading floor and investment teams perform at their peak.
                </p>
...
export default FinancialServicesOverview;
