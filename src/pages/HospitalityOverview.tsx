...
import { ArrowRight, ArrowUpRight, Check, Sparkles, Moon, Sun, Leaf, Star, Users } from "lucide-react";
import { Link } from "react-router-dom";
import { motion } from "framer-motion";

const HospitalityOverview = () => {
  const stats = [
    { value: "35%", label: "Revenue increase", desc: "from wellness programmes" },
    { value: "89%", label: "Guest satisfaction", desc: "with personalised experiences" },
    { value: "4.8★", label: "Average rating", desc: "for wellness services" },
    { value: "52%", label: "Return bookings", desc: "from wellness guests" }
  ];

  const solutions = [
    { 
      title: "Personalised Wellness Journeys", 
      desc: "AI-curated spa and wellness experiences based on guest preferences, biometrics, and real-time stress levels.",
      detail: "Seamless integration with property management systems.",
      num: "01",
      icon: Sparkles
    },
    { 
      title: "Sleep Optimisation Suites", 
      desc: "In-room cognitive wellness technology including circadian lighting, air quality monitoring, and sleep protocols.",
      detail: "Turnkey room upgrade packages available.",
      num: "02",
      icon: Moon
    },
    { 
      title: "Recovery & Rejuvenation", 
      desc: "Red light therapy, photobiomodulation, and evidence-based recovery protocols for spa and wellness centres.",
      detail: "Staff training and certification included.",
      num: "03",
      icon: Sun
    },
  ];
  ...
  const benefits = [
    { title: "Premium positioning", desc: "Differentiate with cutting-edge wellness tech" },
    { title: "Increased ancillary revenue", desc: "Higher-value spa and wellness bookings" },
    { title: "Enhanced guest loyalty", desc: "Memorable wellness experiences drive returns" },
    { title: "Operational efficiency", desc: "Automated guest wellness preferences" }
  ];

  const useCases = [
    { title: "Luxury Hotels & Resorts", desc: "Elevate the guest experience with AI wellness" },
    { title: "Destination Spas", desc: "Comprehensive wellness retreat programmes" },
    { title: "Wellness Retreats", desc: "Immersive cognitive performance experiences" },
    { title: "Cruise Lines", desc: "Onboard wellness and recovery services" }
  ];

  return (
    <>
      <SEO 
        title="Hospitality & Spa Solutions | Neurostate"
        description="AI-powered wellness solutions for luxury hotels, spas, and resorts. Create unforgettable guest experiences with personalised cognitive wellness programmes."
      />
        ...
        <main>
          ...
          <section className="relative min-h-[80vh] flex items-center overflow-hidden">
            ...
            <motion.div 
              ...
              style={{ background: 'radial-gradient(circle, hsl(40, 95%, 55%) 0%, transparent 70%)' }}
            />
              ...
              <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                ...
                >
                  <div className="inline-flex items-center gap-2">
                    ...
                    />
                    <span className="text-[10px] tracking-[0.2em] uppercase text-muted-foreground">Hospitality & Spas</span>
                  </div>

                  <h1 className="text-2xl md:text-3xl lg:text-4xl font-normal text-foreground tracking-tight">
                    Elevate guest wellness.{" "}
                    <span className="text-primary">Elevate your brand.</span>
                  </h1>
                  
                  <p className="text-sm text-muted-foreground max-w-md leading-relaxed">
                    Transform your property into a wellness destination. AI-powered personalised experiences that create lasting impressions and drive premium revenue.
                  </p>
                  ...
                  <div className="flow-card p-8 space-y-6">
                    <div className="flex items-center justify-between pb-4 border-b border-border/50">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p className="text-foreground font-medium text-sm">Guest Wellness</p>
                          <p className="text-muted-foreground text-[10px]">Suite 1204 - Premium</p>
                        </div>
                      </div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      {[
                        { label: "Wellness Score", value: "94", trend: "Excellent" },
                        { label: "Sleep Quality", value: "8.7h", trend: "Deep rest" },
                        { label: "Stress Level", value: "Low", trend: "Relaxed" },
                        { label: "Next Session", value: "10:30", trend: "Spa" }
                      ].map((metric, i) => (
                        <motion.div 
                          key={i}
                        ...
                        >
                          ...
                          <p className="text-[10px] text-primary">{metric.trend}</p>
                        </motion.div>
                      ))}
                    </div>

                    <div className="pt-4 border-t border-border/50">
                      <p className="text-[10px] text-muted-foreground uppercase tracking-wider mb-3">Today's Recommendations</p>
                      <div className="space-y-2">
                        {["Morning yoga at sunrise terrace", "Deep tissue massage at 2pm", "Red light therapy before dinner"].map((rec, i) => (
                          <motion.div 
                            key={i}
            ...
            <div className="max-w-6xl mx-auto">
              <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-start">
                <ScrollReveal className="lg:sticky lg:top-28 space-y-5">
                  <span className="text-[10px] tracking-[0.2em] uppercase text-primary font-medium">Hospitality Solutions</span>
                  <h2 className="text-large-display text-foreground">
                    Premium wellness.
                    <br />
                    <span className="text-muted-foreground">Unforgettable experiences.</span>
                  </h2>
                  <p className="text-sm text-muted-foreground leading-relaxed max-w-sm">
                    From luxury suites to destination spas, our solutions integrate seamlessly to create world-class wellness experiences that guests remember and return for.
                  </p>
                </ScrollReveal>
          ...
          <section className="py-24 md:py-32 px-6 md:px-8 bg-muted/30">
            <div className="max-w-6xl mx-auto">
              <ScrollReveal className="text-center mb-16 space-y-4 max-w-2xl mx-auto">
                <span className="text-[10px] tracking-[0.2em] uppercase text-primary font-medium">Business Benefits</span>
                <h2 className="text-large-display text-foreground">
                  Drive premium revenue.
                  <br />
                  <span className="text-muted-foreground">Build guest loyalty.</span>
                </h2>
              </ScrollReveal>
              ...
              <div className="grid md:grid-cols-2 gap-8 lg:gap-12">
                ...
                <ScrollReveal delay={0.2} direction="right">
                  <div className="space-y-4">
                    <p className="text-[10px] text-muted-foreground uppercase tracking-[0.15em] mb-5 font-medium">Property Types</p>
                    {useCases.map((item, i) => (
                      <motion.div 
                        key={i} 
            ...
            <div className="max-w-4xl mx-auto text-center">
              <ScrollReveal>
                ...
                <p className="text-sm text-muted-foreground max-w-lg mx-auto mb-8">
                  Schedule a property consultation to discover how Neurostate can transform your wellness offerings and create unforgettable guest experiences.
                </p>
