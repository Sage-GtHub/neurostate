...
import { ArrowRight, ArrowUpRight, CheckCircle2, Cpu, Brain, Shield, Target, Users } from "lucide-react";
        ...
        <section ref={hero.ref} className={`relative pt-32 sm:pt-40 pb-20 px-6 md:px-12 lg:px-20 xl:px-32 transition-all duration-1000 ${hero.isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          <div className="max-w-6xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-12 items-start">
              ...
              {/* ROI Calculator */}
              <EnterpriseROICalculator variant="dark" defaultIndustry="saas-high-growth" />
            </div>
          </div>
        </section>
