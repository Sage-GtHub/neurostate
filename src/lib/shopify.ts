...
export const SHOPIFY_STORE_PERMANENT_DOMAIN = 'vital-tech-haven-fwlf0.myshopify.com';
export const SHOPIFY_STOREFRONT_URL = `https://${SHOPIFY_STORE_PERMANENT_DOMAIN}/api/${SHOPIFY_API_VERSION}/graphql.json`;
export const SHOPIFY_STOREFRONT_TOKEN = '0e9cd339633c77c8d90e7896d3d9c0a1';
...
export async function fetchProducts(first: number = 50, query?: string): Promise<ShopifyProduct[]> {
  const data = await storefrontApiRequest(STOREFRONT_QUERY, { first, sortKey: "UPDATED_AT", reverse: true, query });
