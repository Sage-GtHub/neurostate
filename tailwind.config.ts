...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      fontSize: {
        'hero-display': ['5rem', { lineHeight: '1.08', letterSpacing: '-0.03em', fontWeight: '500' }],
        'large-display': ['3rem', { lineHeight: '1.15', letterSpacing: '-0.02em', fontWeight: '500' }],
        'h1': ['2.25rem', { lineHeight: '1.2', letterSpacing: '-0.02em', fontWeight: '500' }],
        'h2': ['1.875rem', { lineHeight: '1.3', letterSpacing: '-0.01em', fontWeight: '500' }],
